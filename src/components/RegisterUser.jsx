...
import { IconWhaterMarkregisterUser } from './svg/iconos';
...
const RegisterUsers = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === 'startDate' && userData.Plan === 'Diario') {
      const lastDayOfMonth = new Date(year, month + 1, 0);
      newUserData.endDate = lastDayOfMonth.toISOString().split('T')[0];
    }
  ...
  const handleSubmit = async () => {
    if (
      ...
      userData.Plan &&
      userData.startDate &&
      userData.nameEmergency &&
      userData.LastNameEmergency &&
      userData.PhoneEmergency &&
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            ...
            <input
              ...
              value={userData.LastNameEmergency}
              onChange={handleInputChange}
            />
          </div>
          <div className="form-group">
            <label>numero de emergncia:</label>
            <input
              type="text"
              name="PhoneEmergency"
              value={userData.PhoneEmergency}
              onChange={handleInputChange}
            />
          </div>
        </div>
